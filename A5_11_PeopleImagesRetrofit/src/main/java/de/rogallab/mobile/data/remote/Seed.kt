 ...
 * - Die Seed-Daten entstehen jetzt im Android-Client. PeopleImagesApi muss keine
 ...
 *   Dateien umgewandelt. SeedApi lädt sie anschließend getrennt von den JSON-
 *   Personendaten hoch.
 * - Erst wenn alle Requests erfolgreich waren, entfernt deleteLocalImages() die
 *   temporären Android-Dateien. Die persistenten Bilder gehören danach dem Server.
 */
