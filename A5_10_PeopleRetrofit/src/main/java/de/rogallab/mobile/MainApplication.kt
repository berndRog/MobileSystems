...
class MainApplication : Application() {
   ...
   override fun onCreate() {
      ...
      startKoin {
         ...
         // A5_10 owns its Retrofit web-service and repository configuration.
         modules(appModule())
 ...
 *   lokale Dateien liefern. Person.imagePath verweist dauerhaft auf diese Dateien;
 *   über Retrofit wird nur der Pfad als nullable JSON-String übertragen.
 */
